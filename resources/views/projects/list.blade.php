@extends('layouts.detached', ['title' => 'Projects List'])
        ...
        <div class="col-md-6 col-xxl-3">
            ...
            <div class="card d-block">
                <div class="card-body">
                    ...
                    <!-- project title-->
                    <h4 class="mt-0">
                        <a href="{{ route('second', ['projects', 'details']) }}" class="text-title">App design and development</a>
                    </h4>
        ...
        <div class="col-md-6 col-xxl-3">
            ...
            <div class="card d-block">
                <div class="card-body">
                    ...
                    <!-- project title-->
                    <h4 class="mt-0">
                        <a href="{{ route('second', ['projects', 'details']) }}" class="text-title">Coffee detail page - Main Page</a>
                    </h4>
        ...
        <div class="col-md-6 col-xxl-3">
            ...
            <div class="card d-block">
                <div class="card-body">
                    ...
                    <!-- project title-->
                    <h4 class="mt-0">
                        <a href="{{ route('second', ['projects', 'details']) }}" class="text-title">Poster illustation design</a>
                    </h4>
                    <div class="badge text-bg-secondary">Ongoing</div>
        ...
        <div class="col-md-6 col-xxl-3">
            ...
            <div class="card d-block">
                <div class="card-body">
                    ...
                    <!-- project title-->
                    <h4 class="mt-0">
                        <a href="{{ route('second', ['projects', 'details']) }}" class="text-title">Drinking bottle graphics </a>
                    </h4>
                    <div class="badge bg-success">Finished</div>
        ...
        <div class="col-md-6 col-xxl-3">
            ...
            <div class="card d-block">
                ...
                <div class="card-body position-relative">
                    <!-- project title-->
                    <h4 class="mt-0">
                        <a href="{{ route('second', ['projects', 'details']) }}" class="text-title">Company logo design</a>
                    </h4>
        ...
        <div class="col-md-6 col-xxl-3">
            ...
            <div class="card d-block">
                ...
                <div class="card-body position-relative">
                    <!-- project title-->
                    <h4 class="mt-0">
                        <a href="{{ route('second', ['projects', 'details']) }}" class="text-title">Landing page design - Home</a>
                    </h4>
        ...
        <div class="col-md-6 col-xxl-3">
            ...
            <div class="card d-block">
                ...
                <div class="card-body position-relative">
                    <!-- project title-->
                    <h4 class="mt-0">
                        <a href="{{ route('second', ['projects', 'details']) }}" class="text-title">Product page redesign</a>
                    </h4>
