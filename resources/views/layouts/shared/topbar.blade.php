            ...
            <div class="app-search dropdown d-none d-lg-block">
                <!--<form>
                    <div class="input-group">
                        <input type="search" class="form-control dropdown-toggle" placeholder="{{ __('Search...') }}" id="top-search">
                        <span class="mdi mdi-magnify search-icon"></span>
                        <button class="input-group-text btn btn-primary" type="submit">{{ __('Search') }}</button>
                    </div>
                </form>-->
                ...
                <div class="dropdown-menu dropdown-menu-animated dropdown-lg" id="search-dropdown">
                    ...
                    <div class="dropdown-header noti-title">
                        <h5 class="text-overflow mb-2">{{ __('Found :count results', ['count' => 17]) }}</h5>
                    </div>
        ...
        <ul class="topbar-menu d-flex align-items-center gap-3">
            ...
            <li class="dropdown">
				<a class="nav-link dropdown-toggle arrow-none" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
					...
					@endphp
					<img src="/images/flags/{{ $flag[app()->getLocale()] ?? 'us' }}.jpg" alt="flag" class="me-0 me-sm-1" height="12">
				...
				<div class="dropdown-menu dropdown-menu-end dropdown-menu-animated">
					@foreach ($locales as $locale)
						<form action="{{ route('change.locale') }}" method="POST" id="locale-{{ $locale }}">
							@csrf
							<input type="hidden" name="locale" value="{{ $locale }}">
							<a href="#" class="dropdown-item" onclick="event.preventDefault(); document.getElementById('locale-{{ $locale }}').submit();">
								<img src="/images/flags/{{ $flag[$locale] ?? 'us' }}.jpg" alt="flag" class="me-1" height="12">
            ...
            <li class="dropdown notification-list">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated dropdown-lg py-0">
                    ...
                    <div class="px-2" style="max-height: 300px;" data-simplebar>
                        <h5 class="text-muted font-13 fw-normal mt-2">{{ __('Today') }}</h5>
                        <!-- item-->
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 text-truncate ms-2">
                                        ...
                                        <small class="noti-item-subtitle text-muted">{{ __('Caleb Flakelar commented on Admin') }}</small>
                                    </div>
                                </div>
                            </div>
                        </a>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 text-truncate ms-2">
                                        ...
                                        <small class="noti-item-subtitle text-muted">{{ __('New user registered') }}</small>
                                    </div>
                                </div>
                            </div>
                        </a>

                        <h5 class="text-muted font-13 fw-normal mt-0">{{ __('Yesterday') }}</h5>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 text-truncate ms-2">
                                        ...
                                        <small class="noti-item-subtitle text-muted">{{ __('Hi, How are you? What about our next meeting') }}</small>
                                    </div>
                                </div>
                            </div>
                        </a>

                        <h5 class="text-muted font-13 fw-normal mt-0">{{ __('30 Dec 2021') }}</h5>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="flex-grow-1 text-truncate ms-2">
                                        ...
                                        <small class="noti-item-subtitle text-muted">{{ __('Wow ! this admin looks good and awesome design') }}</small>
                                    </div>
                                </div>
                            </div>
                        </a>
            ...
            <li class="d-none d-sm-inline-block">
                <div class="nav-link" id="light-dark-mode" data-bs-toggle="tooltip" data-bs-placement="left" title="{{ __('Theme Mode') }}">
                    <i class="ti-moon-line font-22"></i>
                </div>
            </li>

            <li class="d-none d-md-inline-block">
                <a class="nav-link" data-toggle="fullscreen">
                    <i class="ti-fullscreen-line font-22"></i>
                </a>
            </li>-->
            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle arrow-none nav-user px-2" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    <span class="account">
                        <img src="/images/users/avatar-1.jpg" alt="user-image" width="40" class="rounded-circle">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated profile-dropdown">
                    ...
                    <div class="dropdown-header">
                        <span class="text-overflow m-0">{{ __('Welcome !') }}</span>
                    </div>
                    ...
                    <a href="{{ route('reset') }}" class="dropdown-item">
                        <i class="mdi mdi-lock-outline me-1"></i>
...
<script>
    document.getElementById('logout-link').addEventListener('click', function (e) {
        ...
        // Wait a tiny bit to ensure request is fired
        setTimeout(function () {
