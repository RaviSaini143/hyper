@extends('layouts.detached', ['title' => 'Checkout'])
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                ...
                                <form>
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-sm-6">
                                            <a href="{{ route('second', ['ecommerce' , 'shopping-cart']) }}" class="btn text-muted d-none d-sm-inline-block btn-link fw-semibold">
                                                ...
                                                <tr>
                                                    <td>
                                                        ...
                                                        <p class="m-0 d-inline-block align-middle">
                                                            <a href="{{ route('second', ['ecommerce' , 'products-details']) }}" class="text-body fw-semibold">Amazing Modern Chair</a>
                                                            <br>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="/images/products/product-2.jpg" alt="contact-img" title="contact-img" class="rounded me-2"
                                                            height="48" />
                                                        <p class="m-0 d-inline-block align-middle">
                                                            <a href="{{ route('second', ['ecommerce' , 'products-details']) }}" class="text-body fw-semibold">Designer Awesome Chair</a>
                                                            <br>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="/images/products/product-3.jpg" alt="contact-img" title="contact-img" class="rounded me-2"
                                                            height="48" />
                                                        <p class="m-0 d-inline-block align-middle">
                                                            <a href="{{ route('second', ['ecommerce' , 'products-details']) }}" class="text-body fw-semibold">Biblio Plastic Armchair</a>
                                                            <br>
