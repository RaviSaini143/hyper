@extends('layouts.detached', ['title' => 'CRM Orders List'])
                        ...
                        <table class="table table-centered table-nowrap mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a href="{{ route('second', ['ecommerce' , 'orders-details']) }}" class="text-body fw-bold">#CM9708</a>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                            <div class="d-flex align-items-center">
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('second', ['ecommerce' , 'orders-details']) }}" class="text-body fw-bold">#CM9707</a>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                            <div class="d-flex align-items-center">
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('second', ['ecommerce' , 'orders-details']) }}" class="text-body fw-bold">#CM9706</a>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                            <div class="d-flex align-items-center">
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('second', ['ecommerce' , 'orders-details']) }}" class="text-body fw-bold">#CM9705</a>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                            <div class="d-flex align-items-center">
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('second', ['ecommerce' , 'orders-details']) }}" class="text-body fw-bold">#CM9704</a>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                            <div class="d-flex align-items-center">
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('second', ['ecommerce' , 'orders-details']) }}" class="text-body fw-bold">#CM9703</a>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                            <div class="d-flex align-items-center">
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('second', ['ecommerce' , 'orders-details']) }}" class="text-body fw-bold">#CM9702</a>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                            <div class="d-flex align-items-center">
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('second', ['ecommerce' , 'orders-details']) }}" class="text-body fw-bold">#CM9701</a>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                            <div class="d-flex align-items-center">
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('second', ['ecommerce' , 'orders-details']) }}" class="text-body fw-bold">#CM9700</a>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                            <div class="d-flex align-items-center">
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('second', ['ecommerce' , 'orders-details']) }}" class="text-body fw-bold">#CM9699</a>
                                    </td>
                                    <td>
                                        <div class="d-flex">
                                            <div class="d-flex align-items-center">
