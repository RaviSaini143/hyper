@extends('layouts.detached', ['title' => 'Links'])
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-muted font-14">You can use the <code>.link-*</code> classes to colorize links. Unlike
                        the <a href="{{ route('second', ['ui', 'utilities']) }}"><code>.text-*</code> classes</a>, these classes have a <code>:hover</code>
        ...
        <div class="col-xl-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <p class="text-muted font-14"><a href="{{ route('second', ['ui', 'utilities']) }}">Colored link helpers</a> have been updated
