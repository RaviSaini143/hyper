            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="text-start">
                        <p class="text-muted"><strong>Full Name :</strong> <span class="ms-2">{{ $authUser->firstname }} {{ $authUser->lastname }}</span>
                        </p>

                        <p class="text-muted"><strong>Mobile :</strong><span class="ms-2">{{ $authUser->phone }}</span></p>

                        <p class="text-muted"><strong>Email :</strong> <span class="ms-2">{{$authUser->email}}</span></p>

                        <p class="text-muted"><strong>Location :</strong> <span class="ms-2">{{ $authUser->ipaddress }}</span></p>

                       <p class="text-muted"><strong>Address :</strong> <span class="ms-2">{{ $authUser->address }}</span></p>
  <p class="text-muted"><strong>City :</strong> <span class="ms-2">{{ $authUser->city }}</span></p>
  <p class="text-muted"><strong>state :</strong> <span class="ms-2">{{ $authUser->state }}</span></p>
  <p class="text-muted"><strong>Zipcode :</strong> <span class="ms-2">{{ $authUser->zipcode }}</span></p>
